        ...
        <h1 className={headingClassName}>
          ...
          <div className={cn("rw-wrapper")}>
            <div className="rw-words font-extrabold">
              <span className="text-gradient_indigo-purple">Youtube.</span>
              <span className="text-gradient_indigo-purple">Tiktok.</span>
              <span className="text-gradient_indigo-purple">Reddit.</span>
              <span className="text-gradient_indigo-purple">Twitter</span>
              <span className="text-gradient_indigo-purple">Instagram</span>
            </div>
          </div>
        </h1>
        {/* <h1 className={headingClassName}>
